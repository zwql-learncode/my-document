...
Nguồn: Bài viết [gRPC là gì? Vũ khí tối thượng tăng tải Microservices](https://200lab.io/blog/grpc-la-gi) của tác giả Việt Trần tại 200lab Blog
...
gRPC là công nghệ giao tiếp máy chủ-máy khách (client-server) phát triển bởi Google. Nó được thiết kế để tối ưu hóa hiệu suất và độ tin cậy trong việc giao tiếp giữa các dịch vụ phân tán, đặc biệt là trong môi trường microservices. Chúng ta cùng tìm hiểu kỹ hơn về gRPC trong bài viết dưới đây nhé!
...
![Biểu đồ so sánh tốc độ encode/decode giữa JSON, JSON stream và Protobuf](/img/200lab/grpc-benchmark.jpg)

> _So sánh tốc độ encode/decode giữa JSON, JSON stream và Protobuf_
